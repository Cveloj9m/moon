...
<transition name="fade">
  <div id="scene">
    ...
    <div class="slide-fwd-center" v-bind:style="cStyle" v-aaa:onPositionMouseMove>66666666666</div>
    {{position}}
  </div>
</transition>
</template>
...
<style scoped lang="scss">
  ...
  .slide-fwd-center {
    ...
    border: 1px solid red;
	  -webkit-animation: slide-fwd-center 2s linear ;
	        animation: slide-fwd-center 2s linear ;
